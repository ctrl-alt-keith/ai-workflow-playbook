...
class ClaudeReviewLauncherTests(unittest.TestCase):
    def test_project_codex_rule_requires_explicit_approval_for_every_runtime_mode(self):
    ...
    def test_repo_script_runs_auth_preflight_with_a_direct_exact_selector(self):
