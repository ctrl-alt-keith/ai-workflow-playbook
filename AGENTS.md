...
- Keep repository-owned working state repo-local. Use attempt-local disposable
  scratch only for private mechanics that have no required post-attempt role;
  see `docs/repo-readiness.md#repo-local-workflow-state`.
