...
- Target `main` by default. For an eligible stacked pull request, the bottom
  layer targets `main` and each later layer targets the preceding stack branch;
  follow `docs/orchestration-and-parallelism.md`.
